...
// landing page and the assessment app in either direction.
export default function ThemeToggle({ strings }) {
  ...
  return (
    <button
      type="button" className="as-theme-toggle" onClick={toggle}
